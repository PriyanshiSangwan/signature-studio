...
# =========================================================
# PUBLIC PORTFOLIO UPLOAD
#
# IMPORTANT:
# This endpoint intentionally does NOT require login
# because the public portfolio upload button is being
...
async def create_item(
    ...
    if payload.media_type == "reel":
        ...
        # Public uploads are restricted to reels.
        # Designs remain controlled through the admin UI.
...
async def delete_category(
    ...
    if await db.portfolio.count_documents(
        ...
        raise HTTPException(
            400,
            "Remove or move all works in this category before deleting."
        )
...
async def update_team_member(
    ...
    if payload.role is not None:
        ...
        if (
            ...
            raise HTTPException(
                400,
                "You cannot demote your own owner account."
            )
...
# Add FRONTEND_URL automatically if it is different
